...
var invalid = ref.invalid;
var validated = ref.validated;
return [_c('q-input',{ref:"ctrlstatus",attrs:{"outlined":"","dense":"","label":"Status","type":"text","placeholder":"Enter Status","list":"status_list","error":invalid && validated,"error-message":errors[0]},model:{value:(_vm.formData.status),callback:function ($$v) {_vm.$set(_vm.formData, "status", $$v)},expression:"formData.status"}}),_c('datalist',{attrs:{"id":"status_list"}},_vm._l((_vm.$menus.nameItems),function(menu,index){return _c('option',{key:index,domProps:{"value":menu.value}},[_vm._v(_vm._s(menu.label))])}),0)]}}],null,true)})],1)])])]),(_vm.showSubmitButton)?_c('div',{staticClass:"text-center q-my-md"},[_c('q-btn',{attrs:{"rounded":false,"color":"primary","no-caps":"","unelevated":"","type":"submit","disabled":invalid,"icon":"send","loading":_vm.saving}},[_c('q-spinner-oval',{attrs:{"slot":"loading"},slot:"loading"}),_vm._v(" Update\n                                                        ")],1)],1):_vm._e()]}}],null,false,1277130994)}),_vm._t("default",null,{"submit":_vm.submit,"saving":_vm.saving})],2):_c('div',{staticClass:"q-pa-sm text-center"},[_c('q-spinner',{attrs:{"size":40,"color":"accent","indeterminate":""}}),_vm._v("\n                                                Loading...\n                                            ")],1)])])],1)])])])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/submitted_applications/edit.vue?vue&type=template&id=ab831904&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/@quasar/app/lib/webpack/loader.transform-quasar-imports.js!./node_modules/babel-loader/lib??ref--2-0!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/submitted_applications/edit.vue?vue&type=script&lang=js&
...
/* harmony default export */ var editvue_type_script_lang_js_ = ({
  name: 'editSubmittedapplicationsPage',
  components: {},
  ...
  props: {
    ...
    routeName: {
      type: String,
      default: 'submitted_applicationsedit'
    },
    pagePath: {
      type: String,
      default: 'submitted_applications/edit'
    },
    apiPath: {
      type: String,
      default: 'submitted_applications/edit'
  ...
  computed: {
    pageTitle: {
      get: function () {
        return "Edit Submitted Applications";
      }
    }
  },
  ...
  methods: objectSpread2_default()(objectSpread2_default()({}, Object(vuex_esm["b" /* mapActions */])('submitted_applications', ['updateRecord', 'fetchRecord'])), {}, {
    async startRecordUpdate() {
      ...
      if (isFormValid) {
        ...
        this.updateRecord(data).then(response => {
          ...
          this.navigateTo(`/submitted_applications`);
        }, response => {
          this.saving = false;
...
// CONCATENATED MODULE: ./src/pages/submitted_applications/edit.vue?vue&type=script&lang=js&
 /* harmony default export */ var submitted_applications_editvue_type_script_lang_js_ = (editvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/pages/submitted_applications/edit.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  submitted_applications_editvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
//# sourceMappingURL=201.1ed355ce.js.map