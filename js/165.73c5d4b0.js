...
return [_c('q-select',{ref:"ctrlsubmitted_application_id",attrs:{"loading":req.loading,"outlined":"","dense":"","emit-value":"","map-options":"","options":req.response,"label":"Submitted Application Id","error":invalid && validated,"error-message":errors[0]},scopedSlots:_vm._u([{key:"option",fn:function(scope){return [_c('q-item',_vm._g(_vm._b({},'q-item',scope.itemProps,false),scope.itemEvents),[(scope.opt.image)?_c('q-item-section',{attrs:{"avatar":""}},[_c('image-viewer',{attrs:{"src":scope.opt.image,"image-size":"small"}})],1):_vm._e(),_c('q-item-section',[_c('q-item-label'),_vm._v(_vm._s(scope.opt.label)+"\n                                                                            "),(scope.opt.caption)?_c('q-item-label',{attrs:{"caption":""}},[_vm._v(_vm._s(scope.opt.caption))]):_vm._e()],1)],1)]}},{key:"selected-item",fn:function(scope){return [(scope.opt)?_c('q-item',[(scope.opt.image)?_c('q-item-section',{attrs:{"avatar":""}},[_c('image-viewer',{attrs:{"src":scope.opt.image,"image-size":"small"}})],1):_vm._e(),_c('q-item-section',[_c('q-item-label'),_vm._v(_vm._s(scope.opt.label)+"\n                                                                                "),(scope.opt.caption)?_c('q-item-label',{attrs:{"caption":""}},[_vm._v(_vm._s(scope.opt.caption))]):_vm._e()],1)],1):_vm._e()]}}],null,true),model:{value:(_vm.formData.submitted_application_id),callback:function ($$v) {_vm.$set(_vm.formData, "submitted_application_id", $$v)},expression:"formData.submitted_application_id"}})]}}],null,true)})]}}],null,true)})],1)])]),_c('div',{staticClass:"col-12"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-3 col-12"},[_vm._v("\n                                                            Ptp Radio Service Id *\n                                                        ")]),_c('div',{staticClass:"col-sm-9 col-12"},[_c('api-data-source',{attrs:{"api-path":"components_data/ptp_radio_service_id_option_list"},on:{"loaded":function (response) { return _vm.mapOptionField(response, 'ptp_radio_service_id'); }},scopedSlots:_vm._u([{key:"default",fn:function(req){return [_c('ValidationProvider',{attrs:{"rules":{required:true},"name":"Ptp Radio Service Id"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
var invalid = ref.invalid;
var validated = ref.validated;
return [_c('q-select',{ref:"ctrlptp_radio_service_id",attrs:{"loading":req.loading,"outlined":"","dense":"","emit-value":"","map-options":"","options":req.response,"label":"Ptp Radio Service Id","error":invalid && validated,"error-message":errors[0]},scopedSlots:_vm._u([{key:"option",fn:function(scope){return [_c('q-item',_vm._g(_vm._b({},'q-item',scope.itemProps,false),scope.itemEvents),[(scope.opt.image)?_c('q-item-section',{attrs:{"avatar":""}},[_c('image-viewer',{attrs:{"src":scope.opt.image,"image-size":"small"}})],1):_vm._e(),_c('q-item-section',[_c('q-item-label'),_vm._v(_vm._s(scope.opt.label)+"\n                                                                                    "),(scope.opt.caption)?_c('q-item-label',{attrs:{"caption":""}},[_vm._v(_vm._s(scope.opt.caption))]):_vm._e()],1)],1)]}},{key:"selected-item",fn:function(scope){return [(scope.opt)?_c('q-item',[(scope.opt.image)?_c('q-item-section',{attrs:{"avatar":""}},[_c('image-viewer',{attrs:{"src":scope.opt.image,"image-size":"small"}})],1):_vm._e(),_c('q-item-section',[_c('q-item-label'),_vm._v(_vm._s(scope.opt.label)+"\n                                                                                        "),(scope.opt.caption)?_c('q-item-label',{attrs:{"caption":""}},[_vm._v(_vm._s(scope.opt.caption))]):_vm._e()],1)],1):_vm._e()]}}],null,true),model:{value:(_vm.formData.ptp_radio_service_id),callback:function ($$v) {_vm.$set(_vm.formData, "ptp_radio_service_id", $$v)},expression:"formData.ptp_radio_service_id"}})]}}],null,true)})]}}],null,true)})],1)])]),_c('div',{staticClass:"col-12"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-3 col-12"},[_vm._v("\n                                                                    Permit No *\n                                                                ")]),_c('div',{staticClass:"col-sm-9 col-12"},[_c('ValidationProvider',{attrs:{"rules":{required:true},"name":"Permit No"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
var invalid = ref.invalid;
var validated = ref.validated;
return [_c('q-input',{ref:"ctrlpermit_no",attrs:{"outlined":"","dense":"","label":"Permit No","type":"text","placeholder":"Enter Permit No","list":"permit_no_list","error":invalid && validated,"error-message":errors[0]},model:{value:(_vm.formData.permit_no),callback:function ($$v) {_vm.$set(_vm.formData, "permit_no", $$v)},expression:"formData.permit_no"}}),_c('datalist',{attrs:{"id":"permit_no_list"}},_vm._l((_vm.$menus.nameItems),function(menu,index){return _c('option',{key:index,domProps:{"value":menu.value}},[_vm._v(_vm._s(menu.label))])}),0)]}}],null,true)})],1)])])]),(_vm.showSubmitButton)?_c('div',{staticClass:"text-center q-my-md"},[_c('q-btn',{attrs:{"rounded":false,"color":"primary","no-caps":"","unelevated":"","type":"submit","disabled":invalid,"icon":"send","loading":_vm.saving}},[_c('q-spinner-oval',{attrs:{"slot":"loading"},slot:"loading"}),_vm._v(" Update\n                                                        ")],1)],1):_vm._e()]}}],null,false,1278210400)}),_vm._t("default",null,{"submit":_vm.submit,"saving":_vm.saving})],2):_c('div',{staticClass:"q-pa-sm text-center"},[_c('q-spinner',{attrs:{"size":40,"color":"accent","indeterminate":""}}),_vm._v("\n                                                Loading...\n                                            ")],1)])])],1)])])])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/ptpurchase_applications/edit.vue?vue&type=template&id=efebc734&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/@quasar/app/lib/webpack/loader.transform-quasar-imports.js!./node_modules/babel-loader/lib??ref--2-0!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/ptpurchase_applications/edit.vue?vue&type=script&lang=js&
...
/* harmony default export */ var editvue_type_script_lang_js_ = ({
  name: 'editPtpurchaseapplicationsPage',
  components: {},
  ...
  props: {
    ...
    routeName: {
      type: String,
      default: 'ptpurchase_applicationsedit'
    },
    pagePath: {
      type: String,
      default: 'ptpurchase_applications/edit'
    },
    apiPath: {
      type: String,
      default: 'ptpurchase_applications/edit'
  ...
  computed: {
    pageTitle: {
      get: function () {
        return "Edit Ptpurchase Applications";
      }
    }
  },
  ...
  methods: objectSpread2_default()(objectSpread2_default()({}, Object(vuex_esm["b" /* mapActions */])('ptpurchase_applications', ['updateRecord', 'fetchRecord'])), {}, {
    async startRecordUpdate() {
      ...
      if (isFormValid) {
        ...
        this.updateRecord(data).then(response => {
          ...
          this.navigateTo(`/ptpurchase_applications`);
        }, response => {
          this.saving = false;
...
// CONCATENATED MODULE: ./src/pages/ptpurchase_applications/edit.vue?vue&type=script&lang=js&
 /* harmony default export */ var ptpurchase_applications_editvue_type_script_lang_js_ = (editvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/pages/ptpurchase_applications/edit.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  ptpurchase_applications_editvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
//# sourceMappingURL=165.73c5d4b0.js.map