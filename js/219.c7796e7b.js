...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/application_prerequisities/list.vue?vue&type=template&id=80bbaf72&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-page"},[(_vm.showHeader)?[_c('q-card',{staticClass:"page-section q-py-sm q-px-md q-mb-md nice-shadow-18"},[_c('div',{staticClass:"container-fluid"},[_c('div',{staticClass:"row justify-between q-col-gutter-md"},[_c('div',{staticClass:"col-12 col-md-auto "},[_c('div',{},[_c('div',{staticClass:"row  items-center q-col-gutter-sm q-px-sm"},[_c('div',{staticClass:"col"},[_c('div',{staticClass:"text-h6 text-primary"},[_vm._v("Application Prerequisities")])])])])]),_c('div',{staticClass:"col-md-auto col-12 "},[(_vm.$can.view('/application_prerequisities/add'))?[_c('q-btn',{staticClass:"full-width",attrs:{"rounded":false,"size":"","color":"primary","no-caps":"","unelevated":"","to":"/application_prerequisities/add"}},[_c('q-icon',{attrs:{"name":"add"}}),_vm._v("                                \n                                Add New Application Prerequisities \n                            ")],1)]:_vm._e()],2),_c('div',{staticClass:"col-md-auto col-12 "},[_c('q-input',{attrs:{"debounce":"1000","outlined":"","dense":"","placeholder":"Search"},scopedSlots:_vm._u([{key:"append",fn:function(){return [_c('q-icon',{attrs:{"name":"search"}})]},proxy:true}],null,false,4009527860),model:{value:(_vm.searchText),callback:function ($$v) {_vm.searchText=$$v},expression:"searchText"}})],1)])])])]:_vm._e(),_c('section',{staticClass:"page-section q-mb-md"},[_c('div',{staticClass:"container-fluid"},[_c('div',{staticClass:"row q-col-gutter-md"},[_c('div',{staticClass:"col comp-grid"},[_c('div',[(_vm.searchText)?_c('q-chip',{attrs:{"icon":"search","removable":""},on:{"remove":function($event){_vm.searchText='';_vm.$route.query.search=''}}},[_vm._v("\n                        Search: "),_c('strong',{staticClass:"q-ml-sm"},[_vm._v(" "+_vm._s(_vm.searchText)+" ")])]):_vm._e()],1),_c('div',{},[_c('div',[(_vm.showBreadcrumbs)?[(_vm.searchText || _vm.fieldName)?_c('q-breadcrumbs',{staticClass:"q-pa-md"},[(_vm.fieldName)?[(_vm.$route.query.tag)?_c('q-breadcrumbs-el',{staticClass:"text-capitalize",attrs:{"icon":"arrow_back","label":_vm.$route.query.tag,"to":"/application_prerequisities"}}):_c('q-breadcrumbs-el',{staticClass:"text-capitalize",attrs:{"icon":"arrow_back","label":_vm._f("readable")(_vm.fieldName),"to":"/application_prerequisities"}}),(_vm.$route.query.label)?_c('q-breadcrumbs-el',{attrs:{"label":_vm.$route.query.label}}):_c('q-breadcrumbs-el',{attrs:{"label":_vm.fieldValue}})]:_vm._e()],2):_vm._e()]:_vm._e(),_c('div',{staticClass:"relative-position"},[[_c('q-table',{attrs:{"grid":_vm.$q.screen.lt.md,"flat":_vm.$q.screen.gt.md,"table-header-class":"text-h4 ","bordered":false,"columns":_vm.$menus.Application_PrerequisitiesTableHeaderItems,"data":_vm.records,"binary-state-sort":"","separator":"horizontal","dense":true,"selected":_vm.selectedItems,"selection":"multiple","row-key":"id","pagination":_vm.pagination,"hide-bottom":"","loading":_vm.loading},on:{"update:selected":function($event){_vm.selectedItems=$event},"update:pagination":function($event){_vm.pagination=$event},"request":_vm.setPagination},scopedSlots:_vm._u([{key:"body",fn:function(props){return [_c('q-tr',{attrs:{"props":props}},[_c('q-td',{attrs:{"auto-width":""}},[_c('q-checkbox',{model:{value:(props.selected),callback:function ($$v) {_vm.$set(props, "selected", $$v)},expression:"props.selected"}})],1),_c('q-td',{key:"id",attrs:{"props":props}},[_c('q-btn',{attrs:{"padding":"xs","rounded":false,"color":"primary","no-caps":"","unelevated":"","flat":"","to":'/application_prerequisities/view/' + props.row.id}},[_vm._v(_vm._s(props.row.id))])],1),_c('q-td',{key:"application_id",attrs:{"props":props}},[_vm._v("\n                                                "+_vm._s(props.row.application_id)+"\n                                            ")]),_c('q-td',{key:"prerequisite_application_id",attrs:{"props":props}},[_vm._v("\n                                                "+_vm._s(props.row.prerequisite_application_id)+"\n                                            ")]),_c('q-td',{key:"note",attrs:{"props":props}},[_vm._v("\n                                                "+_vm._s(props.row.note)+"\n                                            ")]),_c('q-td',{key:"remark",attrs:{"props":props}},[_vm._v("\n                                                "+_vm._s(props.row.remark)+"\n                                            ")]),_c('q-td',{key:"created_at",attrs:{"props":props}},[_vm._v("\n                                                "+_vm._s(props.row.created_at)+"\n                                            ")]),_c('q-td',{key:"updated_at",attrs:{"props":props}},[_vm._v("\n                                                "+_vm._s(props.row.updated_at)+"\n                                            ")]),_c('q-td',{key:"date_created",attrs:{"props":props}},[(props.row.date_created)?_c('q-chip',{attrs:{"dense":"","size":"13px","label":_vm._f("relativeDate")(props.row.date_created)}},[_c('q-tooltip',{attrs:{"content-class":"bg-accent","transition-show":"scale","transition-hide":"scale"}},[_vm._v("\n                                                "+_vm._s(_vm._f("humanDatetime")(props.row.date_created))+"\n                                                ")])],1):_vm._e()],1),_c('q-td',{key:"date_updated",attrs:{"props":props}},[(props.row.date_updated)?_c('q-chip',{attrs:{"dense":"","size":"13px","label":_vm._f("relativeDate")(props.row.date_updated)}},[_c('q-tooltip',{attrs:{"content-class":"bg-accent","transition-show":"scale","transition-hide":"scale"}},[_vm._v("\n                                                "+_vm._s(_vm._f("humanDatetime")(props.row.date_updated))+"\n                                                ")])],1):_vm._e()],1),_c('q-td',{key:"btnactions",attrs:{"props":props}},[_c('div',{staticClass:"row q-col-gutter-xs justify-end"},[_c('q-btn',{attrs:{"icon":"menu","padding":"xs","round":"","flat":"","color":"grey"}},[_c('q-menu',{attrs:{"transition-show":"flip-right","transition-hide":"flip-left","self":"center middle","anchor":"center middle"}},[_c('q-list',{attrs:{"dense":"","rounded":"","nav":""}},[(_vm.$can.view('application_prerequisities/view'))?[_c('q-item',{directives:[{name:"ripple",rawName:"v-ripple"}],attrs:{"link":"","clickable":"","to":("/application_prerequisities/view/" + (props.row.id))}},[_c('q-item-section',[_c('q-icon',{attrs:{"color":"primary","size":"sm","name":"visibility"}})],1),_c('q-item-section',[_vm._v("View")])],1)]:_vm._e(),(_vm.$can.view('application_prerequisities/edit'))?[_c('q-item',{directives:[{name:"ripple",rawName:"v-ripple"}],attrs:{"link":"","clickable":"","to":("/application_prerequisities/edit/" + (props.row.id))}},[_c('q-item-section',[_c('q-icon',{attrs:{"color":"positive","size":"sm","name":"edit"}})],1),_c('q-item-section',[_vm._v("Edit")])],1)]:_vm._e(),(_vm.$can.view('application_prerequisities/delete'))?[_c('q-item',{directives:[{name:"ripple",rawName:"v-ripple"}],attrs:{"link":"","clickable":""},on:{"click":function($event){return _vm.deleteItem(props.row.id)}}},[_c('q-item-section',[_c('q-icon',{attrs:{"color":"negative","size":"sm","name":"clear"}})],1),_c('q-item-section',[_vm._v("Delete")])],1)]:_vm._e()],2)],1)],1)],1)])],1)]}},{key:"item",fn:function(props){return [_c('div',{staticClass:"q-pa-xs col-xs-12 col-sm-6 col-md-4 col-lg-3 grid-style-transition",style:(props.selected ? 'transform: scale(0.95);' : '')},[_c('q-card',{staticClass:"nice-shadow-18"},[_c('q-card-section',[_c('div',{staticClass:"row q-py-sm q-col-gutter-md justify-content-between"},[_c('div',{staticClass:"col-auto text-caption"},[_vm._v("\n                                                            Id\n                                                        ")]),_c('div',{staticClass:"col text-right"},[_c('q-btn',{attrs:{"padding":"xs","rounded":false,"color":"primary","no-caps":"","unelevated":"","flat":"","to":'/application_prerequisities/view/' + props.row.id}},[_vm._v(_vm._s(props.row.id))])],1)]),_c('div',{staticClass:"row q-py-sm q-col-gutter-md justify-content-between"},[_c('div',{staticClass:"col-auto text-caption"},[_vm._v("\n                                                            Application Id\n                                                        ")]),_c('div',{staticClass:"col text-right"},[_vm._v("\n                                                            "+_vm._s(props.row.application_id)+"\n                                                        ")])]),_c('div',{staticClass:"row q-py-sm q-col-gutter-md justify-content-between"},[_c('div',{staticClass:"col-auto text-caption"},[_vm._v("\n                                                            Prerequisite Application Id\n                                                        ")]),_c('div',{staticClass:"col text-right"},[_vm._v("\n                                                            "+_vm._s(props.row.prerequisite_application_id)+"\n                                                        ")])]),_c('div',{staticClass:"row q-py-sm q-col-gutter-md justify-content-between"},[_c('div',{staticClass:"col-auto text-caption"},[_vm._v("\n                                                            Note\n                                                        ")]),_c('div',{staticClass:"col text-right"},[_vm._v("\n                                                            "+_vm._s(props.row.note)+"\n                                                        ")])]),_c('div',{staticClass:"row q-py-sm q-col-gutter-md justify-content-between"},[_c('div',{staticClass:"col-auto text-caption"},[_vm._v("\n                                                            Remark\n                                                        ")]),_c('div',{staticClass:"col text-right"},[_vm._v("\n                                                            "+_vm._s(props.row.remark)+"\n                                                        ")])]),_c('div',{staticClass:"row q-py-sm q-col-gutter-md justify-content-between"},[_c('div',{staticClass:"col-auto text-caption"},[_vm._v("\n                                                            Created At\n                                                        ")]),_c('div',{staticClass:"col text-right"},[_vm._v("\n                                                            "+_vm._s(props.row.created_at)+"\n                                                        ")])]),_c('div',{staticClass:"row q-py-sm q-col-gutter-md justify-content-between"},[_c('div',{staticClass:"col-auto text-caption"},[_vm._v("\n                                                            Updated At\n                                                        ")]),_c('div',{staticClass:"col text-right"},[_vm._v("\n                                                            "+_vm._s(props.row.updated_at)+"\n                                                        ")])]),_c('div',{staticClass:"row q-py-sm q-col-gutter-md justify-content-between"},[_c('div',{staticClass:"col-auto text-caption"},[_vm._v("\n                                                            Date Created\n                                                        ")]),_c('div',{staticClass:"col text-right"},[(props.row.date_created)?_c('q-chip',{attrs:{"dense":"","size":"13px","label":_vm._f("relativeDate")(props.row.date_created)}},[_c('q-tooltip',{attrs:{"content-class":"bg-accent","transition-show":"scale","transition-hide":"scale"}},[_vm._v("\n                                                            "+_vm._s(_vm._f("humanDatetime")(props.row.date_created))+"\n                                                            ")])],1):_vm._e()],1)]),_c('div',{staticClass:"row q-py-sm q-col-gutter-md justify-content-between"},[_c('div',{staticClass:"col-auto text-caption"},[_vm._v("\n                                                            Date Updated\n                                                        ")]),_c('div',{staticClass:"col text-right"},[(props.row.date_updated)?_c('q-chip',{attrs:{"dense":"","size":"13px","label":_vm._f("relativeDate")(props.row.date_updated)}},[_c('q-tooltip',{attrs:{"content-class":"bg-accent","transition-show":"scale","transition-hide":"scale"}},[_vm._v("\n                                                            "+_vm._s(_vm._f("humanDatetime")(props.row.date_updated))+"\n                                                            ")])],1):_vm._e()],1)])]),_c('q-separator'),_c('div',{staticClass:"row justify-between"},[_c('div',[_c('q-checkbox',{model:{value:(props.selected),callback:function ($$v) {_vm.$set(props, "selected", $$v)},expression:"props.selected"}})],1),_c('q-card-actions',[_c('div',{staticClass:"row q-col-gutter-xs justify-end"},[_c('q-btn',{attrs:{"icon":"menu","padding":"xs","round":"","flat":"","color":"grey"}},[_c('q-menu',{attrs:{"transition-show":"flip-right","transition-hide":"flip-left","self":"center middle","anchor":"center middle"}},[_c('q-list',{attrs:{"dense":"","rounded":"","nav":""}},[(_vm.$can.view('application_prerequisities/view'))?[_c('q-item',{directives:[{name:"ripple",rawName:"v-ripple"}],attrs:{"link":"","clickable":"","to":("/application_prerequisities/view/" + (props.row.id))}},[_c('q-item-section',[_c('q-icon',{attrs:{"color":"primary","size":"sm","name":"visibility"}})],1),_c('q-item-section',[_vm._v("View")])],1)]:_vm._e(),(_vm.$can.view('application_prerequisities/edit'))?[_c('q-item',{directives:[{name:"ripple",rawName:"v-ripple"}],attrs:{"link":"","clickable":"","to":("/application_prerequisities/edit/" + (props.row.id))}},[_c('q-item-section',[_c('q-icon',{attrs:{"color":"positive","size":"sm","name":"edit"}})],1),_c('q-item-section',[_vm._v("Edit")])],1)]:_vm._e(),(_vm.$can.view('application_prerequisities/delete'))?[_c('q-item',{directives:[{name:"ripple",rawName:"v-ripple"}],attrs:{"link":"","clickable":""},on:{"click":function($event){return _vm.deleteItem(props.row.id)}}},[_c('q-item-section',[_c('q-icon',{attrs:{"color":"negative","size":"sm","name":"clear"}})],1),_c('q-item-section',[_vm._v("Delete")])],1)]:_vm._e()],2)],1)],1)],1)])],1)],1)],1)]}}])})],(_vm.loading)?[_c('q-inner-loading',{attrs:{"showing":_vm.loading}},[_c('q-spinner',{attrs:{"color":"primary","size":"30px"}})],1)]:_vm._e(),(!_vm.loading && !_vm.records.length)?[_c('q-card',{attrs:{"flat":_vm.$q.screen.gt.md}},[_c('q-card-section',[_c('div',{staticClass:"text-grey text-h6 text-center"},[_vm._v("\n                                                No record found\n                                            ")])])],1)]:_vm._e(),(_vm.showFooter)?[_c('div',{},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.loading),expression:"!loading"}],staticClass:"q-pa-sm q-my-md"},[_c('div',{staticClass:"row justify-between"},[_c('div',{staticClass:"row q-col-gutter-md"},[(_vm.$can.view('application_prerequisities/delete'))?[_c('div',[(_vm.selectedItems.length)?_c('q-btn',{staticClass:"q-my-xs",attrs:{"display-style":"modal","rounded":false,"no-caps":"","unelevated":"","color":"negative","padding":"xs","icon":"delete_sweep","title":"Delete Selected"},on:{"click":function($event){return _vm.deleteItem(_vm.selectedItems)}}}):_vm._e()],1)]:_vm._e()],2),(_vm.paginate && _vm.totalRecords > 0)?_c('div',{staticClass:"row q-col-gutter-md justify-center"},[_c('div',{staticClass:"col-auto"},[_c('q-chip',[_vm._v("Records "+_vm._s(_vm.recordsPosition)+" of "+_vm._s(_vm.totalRecords))])],1),_c('div',[_c('q-pagination',{attrs:{"color":"primary","flat":"","glossy":"","input":"","direction-links":true,"boundary-links":true,"max-pages":5,"boundary-numbers":true,"max":_vm.totalPages},model:{value:(_vm.pagination.page),callback:function ($$v) {_vm.$set(_vm.pagination, "page", $$v)},expression:"pagination.page"}})],1)]):_vm._e()])])])]:_vm._e()],2)],2)])])])])])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/application_prerequisities/list.vue?vue&type=template&id=80bbaf72&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/@quasar/app/lib/webpack/loader.transform-quasar-imports.js!./node_modules/babel-loader/lib??ref--2-0!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/application_prerequisities/list.vue?vue&type=script&lang=js&
...
/* harmony default export */ var listvue_type_script_lang_js_ = ({
  name: 'listApplicationprerequisitiesPage',
  components: {},
  ...
  props: {
    ...
    pageName: {
      type: String,
      default: 'application_prerequisities'
    },
    routeName: {
      type: String,
      default: 'application_prerequisitieslist'
    },
    apiPath: {
      type: String,
      default: 'application_prerequisities/index'
    },
    multiCheckbox: {
      type: Boolean,
      default: true
  ...
  computed: {
    pageTitle: {
      get: function () {
        ...
        return "Application Prerequisities";
      }
    },
    records: {
      get: function () {
        return this.$store.getters["application_prerequisities/records"];
      },
      set: function (value) {
        this.$store.commit("application_prerequisities/setRecords", value);
      }
    }
  },
  ...
  methods: objectSpread2_default()(objectSpread2_default()({}, Object(vuex_esm["b" /* mapActions */])("application_prerequisities", ["fetchRecords", "deleteRecord"])), {}, {
    load: function () {
      if (!this.loading) {
        this.loading = true;
        let url = this.apiUrl;
...
// CONCATENATED MODULE: ./src/pages/application_prerequisities/list.vue?vue&type=script&lang=js&
 /* harmony default export */ var application_prerequisities_listvue_type_script_lang_js_ = (listvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/pages/application_prerequisities/list.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  application_prerequisities_listvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
//# sourceMappingURL=219.c7796e7b.js.map