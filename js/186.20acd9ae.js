...
return [_c('q-select',{ref:"ctrlpermission_id",attrs:{"loading":req.loading,"outlined":"","dense":"","emit-value":"","map-options":"","options":req.response,"label":"Permission Id","error":invalid && validated,"error-message":errors[0]},model:{value:(_vm.formData.permission_id),callback:function ($$v) {_vm.$set(_vm.formData, "permission_id", $$v)},expression:"formData.permission_id"}})]}}],null,true)})]}}],null,true)})],1)])]),_c('div',{staticClass:"col-12"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-3 col-12"},[_vm._v("\n                                                    Role Id *\n                                                ")]),_c('div',{staticClass:"col-sm-9 col-12"},[_c('api-data-source',{attrs:{"api-path":"components_data/role_id_option_list"},on:{"loaded":function (response) { return _vm.mapOptionField(response, 'role_id'); }},scopedSlots:_vm._u([{key:"default",fn:function(req){return [_c('ValidationProvider',{attrs:{"rules":{required:true},"name":"Role Id"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
var invalid = ref.invalid;
var validated = ref.validated;
return [_c('q-select',{ref:"ctrlrole_id",attrs:{"loading":req.loading,"outlined":"","dense":"","emit-value":"","map-options":"","options":req.response,"label":"Role Id","error":invalid && validated,"error-message":errors[0]},model:{value:(_vm.formData.role_id),callback:function ($$v) {_vm.$set(_vm.formData, "role_id", $$v)},expression:"formData.role_id"}})]}}],null,true)})]}}],null,true)})],1)])])]),(_vm.showSubmitButton)?_c('div',{staticClass:"text-center q-my-md"},[_c('q-btn',{attrs:{"rounded":false,"color":"primary","no-caps":"","unelevated":"","type":"submit","disabled":invalid,"icon":"send","loading":_vm.saving}},[_c('q-spinner-oval',{attrs:{"slot":"loading"},slot:"loading"}),_vm._v(" Update\n                                        ")],1)],1):_vm._e()]}}],null,false,1738921207)}),_vm._t("default",null,{"submit":_vm.submit,"saving":_vm.saving})],2):_c('div',{staticClass:"q-pa-sm text-center"},[_c('q-spinner',{attrs:{"size":40,"color":"accent","indeterminate":""}}),_vm._v("\n                                Loading...\n                            ")],1)])])],1)])])])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/role_has_permissions/edit.vue?vue&type=template&id=aad35b06&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/@quasar/app/lib/webpack/loader.transform-quasar-imports.js!./node_modules/babel-loader/lib??ref--2-0!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/role_has_permissions/edit.vue?vue&type=script&lang=js&
...
/* harmony default export */ var editvue_type_script_lang_js_ = ({
  ...
  methods: objectSpread2_default()(objectSpread2_default()({}, Object(vuex_esm["b" /* mapActions */])('role_has_permissions', ['updateRecord', 'fetchRecord'])), {}, {
    async startRecordUpdate() {
      ...
      if (isFormValid) {
        ...
        this.updateRecord(data).then(response => {
          ...
          this.navigateTo(`/role_has_permissions`);
        }, response => {
          this.saving = false;
...
// CONCATENATED MODULE: ./src/pages/role_has_permissions/edit.vue?vue&type=script&lang=js&
 /* harmony default export */ var role_has_permissions_editvue_type_script_lang_js_ = (editvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/pages/role_has_permissions/edit.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  role_has_permissions_editvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
//# sourceMappingURL=186.20acd9ae.js.map